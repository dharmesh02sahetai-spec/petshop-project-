...
$subcat=$obj->query("select * from studio_register");
?>
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th style="width:20%">Studio Name</th>
											<th style="width:20%">Studio Mobile</th>
											<th style="width:20%">Studio Email</th>
											<th style="width:20%">Studio Address</th>

...
if(isset($_POST['submit']))
{
    ...
    $e = strtolower(end($exe));
    	...
    	{
    		$exe=$obj->query("insert into slideriamges(images)
			values('$upload_url')");
...
<main class="content">
	<div class="container-fluid p-0">
					...
					<h1 class="alert alert-info h2 p-3">Add APP SLIDER IMAGES</h1> 
...
<div class="row mb-4">
	<label class="col-form-label col-sm-3 text-sm-right font-weight-bold">App Slider Image</label>
		<div class="col-sm-7">
